...
export default function StudentQuizQuestions({saveQuestion,count,handleQuestions,isOpened,NextBtn,submitBtn}) {
            ...
            <div className='container-fluid mainPage pl-4 pr-4'>
                ...
                <div className="row w-100">
                    ...
                    <div className="col-12">
                        ...
                        <h1 className='loginH1 marksH1 quizQuestionH1 studentQuizH1'>Sınav</h1>
 
                            <div className="containerLogin teacherContainer containerQuestion">

                                {saveQuestion.length == 0 && <h1 className='emptyQuizH1'>Şuan sınav yok</h1> }
                        
                                {saveQuestion.length == 0 && <Link to='studentDashboard'> <button style={{width:'50%', marginTop: '2rem'}} className='startBtn loginBtn backBtn' type='button'>Tabloya Dön</button> </Link>}
                                ...
                                {saveQuestion.length > 0 && <div className="stundentQuizDiv">
                                    ...
                                    {count === saveQuestion.length - 1 && <Link to='studentDashboard'><button type='button' onClick={submitBtn} className='startBtn loginBtn submitBtn'>Gönder</button></Link>}

                                    {count !== saveQuestion.length - 1 && <button type='button' onClick={handleQuestions} className='startBtn loginBtn submitBtn'>Sonraki</button>}
